...
public class PunStuff : MonoBehaviourPunCallbacks
{
    ...
    private void Awake()
    {
        ...
        userNameInputField.text = PlayerPrefs.GetString(UserNameKey, "asd");
    ...
    public void OpenRecordingsMenu()
    {
        ...
        if (Directory.Exists(path))
        {
            ...
            foreach (var file in files)
            {
                ...
                var fileInfo = $"Name: {file.Name}, Size{file.Length}";
    ...
    public void JoinLobby()
    {
        ...
        PlayFabClientAPI.LoginWithCustomID(new LoginWithCustomIDRequest
            ...
            obj =>
            {
                ...
                {
                    errorMessage.text = "connect to master2";
